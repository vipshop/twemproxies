...
#define NC_CONTEXT_ROLE_WORKER  2

#define NC_SOURCE_TYPE_PROXY    0
#define NC_SOURCE_TYPE_REDIS    1
#define NC_SOURCE_TYPE_MC       2
...
rstatus_t core_calc_connections(struct context *ctx);
