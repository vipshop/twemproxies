...
struct mbuf_base {
    uint32_t nfree_mbufq;   /* # free mbuf */
    struct mhdr free_mbufq; /* free mbuf q */
...
void mbuf_init(size_t mbuf_chunk_size, struct mbuf_base *mbufb);
void mbuf_deinit(struct mbuf_base *mbufb);
struct mbuf *mbuf_get(struct mbuf_base *mbufb);
...
size_t mbuf_data_size(struct mbuf_base *mbufb);
